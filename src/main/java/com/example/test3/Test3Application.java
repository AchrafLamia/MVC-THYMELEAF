...
public class Test3Application {
    ...
    CommandLineRunner commandLineRunner
        ...
        return args -> {
            patienRepository.save(new Patient(null,"hassan",new Date(),false,12));
            patienRepository.save(new Patient(null,"hanan",new Date(),true,12));
            patienRepository.save(new Patient(null,"morad",new Date(),true,12));
            patienRepository.save(new Patient(null,"youssef",new Date(),false,12));
